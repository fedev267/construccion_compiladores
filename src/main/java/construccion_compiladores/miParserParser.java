...
public class miParserParser extends Parser {
	...
	public static class SContext extends ParserRuleContext {
		...
		public TerminalNode NUMERO() { return getToken(miParserParser.NUMERO, 0); }
		public TerminalNode OTRO() { return getToken(miParserParser.OTRO, 0); }
		public TerminalNode EOF() { return getToken(miParserParser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof miParserListener ) ((miParserListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof miParserListener ) ((miParserListener)listener).exitS(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof miParserVisitor ) return ((miParserVisitor<? extends T>)visitor).visitS(this);
